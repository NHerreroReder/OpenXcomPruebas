...
RuleCraft::RuleCraft(const std::string &type, int listOrder) :
	...
	_keepCraftAfterFailedMission(false), _allowLanding(true), _spacecraft(false), _notifyWhenRefueled(false), _autoPatrol(false), _undetectable(false),_missilePower(0),
