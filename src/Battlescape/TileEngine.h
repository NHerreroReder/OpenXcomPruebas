...
public:
	...
	/// Checks validity for targetting a unit (Realistic Cover Accuracy System)
	bool canTargetUnitRCAS(Position *originVoxel, Tile *tile, Position *scanVoxel, BattleUnit *excludeUnit, bool rememberObstacles, BattleUnit *potentialUnit = 0);
